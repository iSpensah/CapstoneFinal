    ...
    <section class="home-section">
      ...
      <div class="home-content">
        ...
        <div class="container home p-5">
          ...
          <form action="../updateCouponDetails">
      	<input type="number" class="read form-control mt-2 pl-3" placeholder="Enter Coupon Id" required name="cid" value='${coupon.cid}' readonly>
        <input type="text" class="form-control mt-2 pl-3" placeholder="Enter Coupon Name" required name="coupname" value='${coupon.coupname}'>
        <input type="text" class="form-control mt-2 pl-3" placeholder="Enter Coupon Description" required name="coupdesc" value='${coupon.coupdesc}'>
<%--         <input type="number" class="form-control mt-2 pl-3" placeholder="Enter Promotional Event ID" required name="pid" value='${coupon.pid}' readonly> --%>
                    <select class="custom-select" required name="pid">
				  <option>${coupon.eventname}</option>
				  <option disabled>---------------------</option>
            <c:forEach var="eventname" items="${allevents}">
					    <option value='${eventname.pid}'>${eventname.eventname}</option>
				    </c:forEach>
			  </select> 
        <input type="number" class="form-control mt-2 pl-3" placeholder="Enter Coupon Discount" required name="discount" value='${coupon.discount}'>
      	<input type="submit" value="Update Coupon" class="btn btn-info btn-lg btn-block mt-2"/>
      </form>
