  ...
  <body>
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="../admin-event">
            <i class='bx bx-calendar-event icon' class="active"></i>
    ...
    <section class="home-section">
      ...
      <div class="home-content">
        ...
        <div class="container home p-5">
          <h2>Add Promotional Event</h2>
          <p>Please enter the following ...</p>
          <form action="saveNewEvent">
            <input type="text" class="form-control mt-2 pl-3" required name="eventname" placeholder="Enter Event Name" value='${event.eventname}' />
            <input type="date" id="start" class="form-control mt-2 pl-3" required name="eventstartdate" value='${event.eventstartdate}'/>
            <input type="date" id="end" class="form-control mt-2 pl-3" required  name="eventenddate" value='${event.eventenddate}' />
            <div style="color:#ff0000;" id="message"></div>
            <input type="text" class="form-control mt-2 pl-3" required name="eventdesc"  placeholder="Enter Event description" value='${event.eventdesc}'/>
            <input type="submit" id="submit" class="btn btn-primary btn-lg btn-block mt-2"  value="Add New Event"/>
            </form>
