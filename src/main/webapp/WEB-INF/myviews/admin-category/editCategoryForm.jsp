...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-section">
      ...
      <form action="../updateCategoryDetails">
      	<input type="number" class="read form-control mt-2 pl-3" placeholder="Enter Category Id" required name="categoryId" value='${category.categoryId}' readonly>
        <input type="text" class="form-control mt-2 pl-3" placeholder="Enter Category Name" required name="categoryName" value='${category.categoryName}'>
        <textarea class="form-control mt-2 pl-3" placeholder="Enter Description" required name="categoryDesc" rows="5">${category.categoryDesc}</textarea>
      	<input type="submit" value="Update Category" class="btn btn-info btn-lg btn-block mt-2"/>
      </form>
